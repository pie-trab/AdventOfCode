...
alredy_visited = [(curr_pos[0], curr_pos[1], 0)]
        ...
        match direction:    
            case 0:
                ...
                if matrix[curr_pos[0] - 1][curr_pos[1]] == '#':
                    ...
                    if (curr_pos[0], curr_pos[1], 0) in alredy_visited:
                       count += 1
                    else:
                       alredy_visited.append((curr_pos[0], curr_pos[1], 0))
            ...
            case 1:
                ...
                if matrix[curr_pos[0]][curr_pos[1] + 1] == '#':
                    ...
                    if (curr_pos[0], curr_pos[1], 1) in alredy_visited:
                       count += 1
                    else:
                       alredy_visited.append((curr_pos[0], curr_pos[1], 1))
                    matrix[curr_pos[0]][curr_pos[1]] = 'O'
            case 2:
                ...
                if matrix[curr_pos[0] + 1][curr_pos[1]] == '#':
                    ...
                    curr_pos = [curr_pos[0] + 1, curr_pos[1]]
                    if (curr_pos[0], curr_pos[1], 2) in alredy_visited:
                       count += 1
                    else:
                       alredy_visited.append((curr_pos[0], curr_pos[1], 2))
                    matrix[curr_pos[0]][curr_pos[1]] = 'O'
            case 3:
                if curr_pos[1] - 1 < 0:
                    in_lab = False
                ...
                if matrix[curr_pos[0]][curr_pos[1] - 1] == '#':
                    ...
                    curr_pos = [curr_pos[0], curr_pos[1] - 1]
                    if (curr_pos[0], curr_pos[1], 3) in alredy_visited:
                       count += 1
                    else:
                       alredy_visited.append((curr_pos[0], curr_pos[1], 3))
                    matrix[curr_pos[0]][curr_pos[1]] = 'O'
